...
module.exports = configure = deferred(function(action, params) {
  var compile, connect, filename, interpret, marshal, notify, port, read, reject, resolve, validate;
  if (params == null) {
    params = {};
  }
  resolve = action.resolve, reject = action.reject, notify = action.notify;
  filename = params.filename, connect = params.connect, port = params.port;
